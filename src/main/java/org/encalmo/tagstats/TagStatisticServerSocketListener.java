...
public class TagStatisticServerSocketListener implements ServerSocketListener {
    private final TagStats<String> tags;
    private final Charset charset;

    public TagStatisticServerSocketListener(TagStats<String> tags, Charset charset) {
        this.tags = tags;
