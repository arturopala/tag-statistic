...
public class GenericTagStatsService implements TagStatsService, ManageableService {
  ...
  public GenericTagStatsService(TagSet<String> tagSet, TagParser tagParser, FileParser fileParser,
                                MultiplexedServerSocket server, DirectoryScanAndWatch watch) {
    this.tagSet = tagSet;
